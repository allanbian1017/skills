...
### R03: Handle Type Assertion Failures
- **Severity**: HIGH
- **Category**: Guidelines
...
### R08: Use Time Package for Durations
- **Severity**: HIGH
- **Category**: Guidelines
...
### R13: Field Tags in Marshaled Structs
- **Severity**: MEDIUM
- **Category**: Guidelines
...
### R16: Preallocate Slice and Map Capacity
- **Severity**: MEDIUM
...
### R18: Avoid Repeated String-to-Byte Conversions
- **Severity**: MEDIUM
- **Category**: Performance
...
### R19: Reduce Nesting (Guard Clauses)
- **Severity**: MEDIUM
- **Category**: Style
...
### R22: Use Field Names to Initialize Structs
- **Severity**: MEDIUM
- **Category**: Style
...
### R24: Top-Level Variable Declarations
- **Severity**: LOW
- **Category**: Style
...
### R25: Prefix Unexported Top-Level Variables
- **Severity**: LOW
- **Category**: Style
...
### R26: Avoid Shadowing Built-In Identifiers
- **Severity**: LOW
- **Category**: Style
...
### C01: Pointer vs Value Receivers
- **Category**: Guidelines
...
### C02: Copy Slices and Maps at Boundaries
- **Category**: Guidelines
...
### C03: Zero-Value Mutexes and Struct Embedding
- **Category**: Guidelines
...
### C04: Channel Sizing and Concurrency Coordination
- **Category**: Guidelines
...
### C05: Interface Compliance Verification
- **Category**: Guidelines
...
### C06: Avoid Embedding Types in Public Structs
- **Category**: Guidelines
...
### C07: Atomic Primitives vs Mutexes
- **Category**: Performance
...
### C08: Functional Grouping and Ordering
- **Category**: Style
...
### C10: Line Length and Visual Wrap
- **Category**: Style
...
### C11: Package Naming and Granularity
- **Category**: Style
...
### C12: Functional Options Pattern
- **Category**: Patterns
