...
| :-------- | :------- | :-- |
| Research/exploration done, ready to build | Yes | Research context is large; the plan is what matters |
| Planning done, starting to code | Yes | Plan is already in TodoWrite or a file |
